...
/**
 * @brief Return the indexes of the closest lattice point in the grid 
 *        below a given set of x, y and z coordinates.
 *
 * @param grid [IN] the computational grid
 * @param x [IN] the x coordinate
 * @param y [IN] the y coordinate
 * @param z [IN] the z coordinate
 * @param cx [OUT] the below x index
 * @param cy [OUT] the below y index
 * @param cz [OUT] the below z index
 */
