...
typedef struct simulation_data {
  ...
  local_data_t *c, *rho, *rhohalf;
  local_data_t *pold, *pnew;
  local_data_t *vxold, *vxnew;
  local_data_t *vyold, *vynew;
  local_data_t *vzold, *vznew;
...
/**
 * @brief Allocate communication buffers for pressure and velocity updates.
 *
 * @param numnodesx [IN] Number of nodes along the x-axis.
 * @param numnodesy [IN] Number of nodes along the y-axis.
 * @param numnodesz [IN] Number of nodes along the z-axis.
 */
void allocate_comm_buffers(int numnodesx, int numnodesy, int numnodesz);

/**
 * @brief Free the allocated communication buffers.
 */
